...
namespace SampleProduct.View.Scene.MainScene.SceneSample1
{
    public class SceneSample1Scene : ProductCanvasMainSceneBase<SceneSample1Scene.SceneSample1TransitionData>
    {
        ...
        [Inject]
        public void Construct(ISceneSample1Presenter sceneSample1Presenter)
        {
        ...
        protected override UniTask OnEnter(SceneSample1TransitionData transitionData, ISceneTransitionContext context, CancellationToken cancelToken)
        {
