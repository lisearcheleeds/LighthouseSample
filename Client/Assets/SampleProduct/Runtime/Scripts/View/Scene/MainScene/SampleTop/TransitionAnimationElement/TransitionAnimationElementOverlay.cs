...
{
    public sealed class TransitionAnimationElementOverlay : ProductScreenStackBase, IScreenStackSetup<TransitionAnimationElementPresenter, TransitionAnimationElementData>
    {
